...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Francis Perini";
    private static final String CONTACT_GITHUB = "https://gtihub.com/fperini40";
    private static final String CONTACT_EMAIL = "fperini@gmail.com";
